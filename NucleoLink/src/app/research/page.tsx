...
import { ResearchDataProvider, useResearchData } from "@/app/context/ResearchDataContext";

function PubChemContent() {
  const [compoundName, setCompoundName] = useState("");
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState("");
  const { compoundData, setCompoundData } = useResearchData();
